    ...
    <div class="main-content">
        <div class="form-container">
            ...
            <form action="<?php echo e(route('tenants.store')); ?>" method="POST">
                ...
                <input type="email" id="business_email" name="business_email" value="<?php echo e(old('business_email', old('email'))); ?>" required>
                ...
                <input type="text" id="admin_name" name="admin_name" value="<?php echo e(old('admin_name', old('name'))); ?>" required>

                <label for="admin_email">Administrator Email:</label>
                <input type="email" id="admin_email" name="admin_email" value="<?php echo e(old('admin_email', old('business_email', old('email')))); ?>" required>

                <label for="domain">Custom Domain (optional):</label>
                <input type="text" id="domain" name="domain" placeholder="ramcar.localhost" value="<?php echo e(old('domain')); ?>">
